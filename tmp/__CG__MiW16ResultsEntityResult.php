 ...
 */
class Result extends \MiW16\Results\Entity\Result implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', 'id', 'result', 'time', '' . "\0" . 'MiW16\\Results\\Entity\\Result' . "\0" . 'user'];
        }
     ...
     * {@inheritDoc}
     */
    public function setUser(\MiW16\Results\Entity\User $user)
    {
